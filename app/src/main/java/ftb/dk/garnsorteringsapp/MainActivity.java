...
//https://stackoverflow.com/questions/49552759/how-to-set-google-drive-image-link-to-imageview
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        MakeRequestTask(GoogleAccountCredential credential) {
            ...
            mService = new com.google.api.services.sheets.v4.Sheets.Builder(
                    ...
                    .setApplicationName("Garn sorterings app")
                    .build();
        }
        ...
        private List<String> getDataFromApi() throws IOException {
            String spreadsheetId = getResources().getString(R.string.sheetID);
            String range = "Ark1!A2:B2";
